...
Agent 1. create a new Subagent called Creator who will produce a Neurology YouTube video shorts pipeline
This document should be inserted into the skill.md of this subagent
...
Remember all of this context going forward. Use it for everything you do:

Career:
- Grow my YouTube channel to 100k subscribers
- Grow my X followers to 150k
...
Use this context whenever deciding what tasks to work on. Connect dots across these goals and find opportunities I'd miss.

---

# STEP 2: Daily Autonomous Task Generation & Execution

Every morning at 8:00 AM:

1. Come up with 4-5 tasks that you can complete on my computer that move me closer to my goals
2. Schedule and complete those tasks yourself using sessions_spawn / sessions_send
3. Update the Kanban board as you work

Example tasks (but be creative):
- Research trending YouTube topics in AI + Neurology, draft video scripts
- Analyze top X accounts in my niche, identify growth patterns
- Draft blog posts or threads for my community
- Build features for my SaaS product
- Research potential partnerships or collaboration opportunities
- Write and schedule social media content
- Build me a surprise mini-app MVP that advances one of my goals

Every week on Sunday at 8 am
It should scan the journals of JNIS, INR, AJNR, muscle and nerve, clinical electrophysiology and sleep for new procedures, interventions, electrophysiological tests, sleep tests and new questionnaires


Track everything on the Kanban board. Update it in real-time as you complete tasks.

---

# STEP 3: Safe Sub-Agent Task Execution

When spawning sub-agents to execute tasks:
...
X posts
Ultimate Viral Hooks Prompt
Role: You are my X (Twitter) Hook Writer. Your job is to craft 5 scroll-stopping hooks for my post. Each hook must be 1–2 punchy sentences (~140 chars max), feel like a pattern interrupt, and make the reader NEED to keep reading. Write for strangers. No fluff. No LinkedIn tone.
My Idea: If I’m posting about: “The Ultimate Vibe Coding Prompt” — a prompt that makes AI act like your technical co-founder and helps you ship real products (not prototypes).
How serious I am 🟢 I’m just exploring / 🟠 I want better engagement / 🔴 I want more saves / 🟣 I want viral reach
Project Framework
Phase 1: Discovery
* Ask: What’s the main reader pain here? (not shipping, bad prompts, getting toy outputs)
* Identify the universal tension: “AI is powerful but you’re not getting real results”
* Decide the hook angle: shipping products, co-founder framing, prompt quality gap
* Confirm the vibe: raw, direct, timeline-native
Phase 2: Hook Rules (non-negotiable)
* Hook is about the READER or universal tension, never about me
* Create an open loop: contradiction, question, bold claim, or tension
* No humble brag, no “I just did X”
* No emojis, no hashtags, no “thread” announcements
* Must feel like “wait... explain”
* X tone: sharp, simple, fast
* Shorter > longer. Every word earns its place
Phase 3: Hook Techniques (choose 1 per hook)
* Contradiction + unexpected context
* Specific struggle
* Absurd frame
* Hot take with implied proof
* Micro-story opener (without “I”)
...
* One link max strategically
Phase 5: Output Format
Generate 5 hook options ranked from safest → most provocative. For each hook include:
* Hook text (1–2 sentences, <140 chars max)
* Technique & why it works for this topic
Constraints:
* No emojis at the start
* No hashtags in the hook
* No “thread” labels
* No mention of “I” or personal results in the hook
...
python -m verticals topics --niche neurology --limit 20


--niche NAME         Niche profile (default: general)
--provider NAME      LLM provider: ollama (default: minimax), qwen
...
--lang CODE          Language: en, Malayalam , hindi (default: en)
...
python -m verticals run \
  ...
  --provider ollama \
  --voice edge \
  --visuals pexels or Gemini Imagen
```
